...
// Differs from stock nice_view: 30 images here, balloon + mountain upstream.
static const lv_img_dsc_t *const art_imgs[] = {
    &hammerbeam1,
    &hammerbeam2,
    &hammerbeam3,
    &hammerbeam4,
...
int zmk_widget_status_init(struct zmk_widget_status *widget, lv_obj_t *parent) {
    ...
    // Differs from stock nice_view: random pick from art_imgs instead of a coin flip.
    lv_img_set_src(art, art_imgs[sys_rand32_get() % ARRAY_SIZE(art_imgs)]);
